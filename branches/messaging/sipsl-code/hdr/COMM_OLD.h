...
class BASEMESSAGE {
    public:
        ...
        string getLineMessage(int);
        int getLineParsed(int);
        int getTotLines(void);

        void setLineParsed(int,int);
		
		// When is generated internally by the state machine
		// it is set to empty
		bool iscomplete;
    ...
    private:
        ...
        string lineMessage[MAXLINES];

        int lineParsed[MAXLINES]; // 0 not parsed, 1 parsed, 2 ....
...
//
// RequestURI 
//     SIPGENURI = "SIP-URI" or "SIPS-URI" or absoluteURI
//
// SipRequest "Method RequestURI SipVersion<CRLF>"
///////////////////////////////////////////////////////////////////////////////
// 081108
...
// ??? private 
    ...
    private:
        string content;
        virtual bool doParse(void) = 0;
}
///////////////////////////////////////////////////////////////////////////////
class SIPGENURI{ // sip or sips
    private:
        bool doParse(void);
...
// 081108
// RequestURI
// RequestURI "SIP-URI" or "SIPS-URI" or absoluteURI
class RequestURI {

    public
        int type;
        SIPGENURI sipuri; //sip or sips
...
class MESSAGE : public BASEMESSAGE {
    public:
        MESSAGE(string message, int sock, struct sockaddr_in echoClntAddr);
        MESSAGE();
